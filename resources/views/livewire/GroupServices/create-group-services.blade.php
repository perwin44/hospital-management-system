...
@ramymagdy841
2 weeks ago
المشكلة في استخدام ال mcmara
الحل هو الكود ده تكتبه داخل الroute بتاع ال mcmara
Livewire::setUpdateRoute(function ($handle) { =Mcmara Package
            return Route::post('/livewire/update', $handle);
        });
وبعد كده اكتب كل اي route هيشتغل عادي خالص --}}
...
<div>
    ...
    {{--    @endif--}}
        ...
        @else
            <form wire:submit="saveGroup" autocomplete="off">
                @csrf
                <div class="form-group">
                    <label>اسم المجموعة</label>
                    <input wire:model.live="name_group" type="text" name="name_group" class="form-control" required>
                </div>
