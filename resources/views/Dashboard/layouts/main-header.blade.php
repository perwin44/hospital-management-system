								...
								<div class="dropdown-menu">
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        ...
                                        onclick="event.preventDefault();
                                                    this.closest('form').submit();"><i class="bx bx-log-out"></i> تسجيل خروج</a>
									...
									{{-- <a class="dropdown-item" href="{{ url('/' . $page='page-signin') }}"><i class="bx bx-log-out"></i> تسجيل خروج</a> --}}
								</div>
							</div>
...
<script>
    ...
    new_message.hide();
                ...
                // var pusher = new Pusher('1cfcc348263486d2dca8', {
                //   cluster: 'mt1'
                // });
